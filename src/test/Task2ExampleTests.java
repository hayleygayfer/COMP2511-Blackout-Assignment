...
public class Task2ExampleTests {
    ...
    public void testExample() {
        ...
        String initialWorldState = new ResponseHelper(LocalTime.of(0, 0))
                ...
                .expectDevice("LaptopDevice", "DeviceB", 180).expectDevice("DesktopDevice", "DeviceC", 330, false,
        ...
        TestHelper plan = new TestHelper().createDevice("HandheldDevice", "DeviceA", 30)
                ...
                .scheduleDeviceActivation("DeviceC", LocalTime.of(0, 0), 300).showWorldState(initialWorldState)
                .simulate(1440).showWorldState(afterADay);
    ...
    public void testHalfADay() {
        ...
        String initialWorldState = new ResponseHelper(LocalTime.of(0, 0)).toString();

        // then simulates for a full day (720 mins)
        String afterADay = new ResponseHelper(LocalTime.of(12, 0)).toString();

        TestHelper plan = new TestHelper().showWorldState(initialWorldState).simulate(720).showWorldState(afterADay);
        plan.executeTestPlan();
    }
