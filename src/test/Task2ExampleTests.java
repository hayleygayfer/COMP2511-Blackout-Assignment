...
public class Task2ExampleTests {
    ...
    public void testExample() {
        ...
        // then simulates for 500 minutes
        String after500Minutes = new ResponseHelper(LocalTime.of(8, 20))
            .expectSatellite("NasaSatellite", "Satellite1", 10000, 344.25, 85,
                    new String[] { "DeviceA", "DeviceC" },
                    new DummyConnection[] {
            ...
            .expectDevice("HandheldDevice", "DeviceA", 30, false,
                    new LocalTime[][] { { LocalTime.of(0, 0), LocalTime.of(6, 40) } })
            .expectDevice("LaptopDevice", "DeviceB", 180)
            .expectDevice("DesktopDevice", "DeviceC", 330, true,
                    new LocalTime[][] { { LocalTime.of(7, 0), LocalTime.of(12, 0) } })
            .toString();
        ...
        TestHelper plan = new TestHelper().createDevice("HandheldDevice", "DeviceA", 30)
            ...
            .simulate(500)
            .showWorldState(after500Minutes);
    ...
    public void testMovementOfSatellites() {
        ...
        String finalWorldState = new ResponseHelper(LocalTime.of(0, 0))
            .expectSatellite("NasaSatellite", "BadBatch", 6000, 290.4, 85,
                            new String[] {})
            .expectSatellite("SovietSatellite", "FalconAndTheWinterSoldier", 6000, 164, 100,
                            new String[] {})
    ...
    public void testSovietSatelliteMovement() {
        ...
        String finalWorldState = new ResponseHelper(LocalTime.of(0, 0))
            ...
            .expectSatellite("SovietSatellite", "FalconAndTheWinterSoldier", 6000, 176, -100,
                new String[] {})
            .toString();
